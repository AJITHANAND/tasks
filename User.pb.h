...
inline std::string* User::unsafe_arena_release_email() {
  // @@protoc_insertion_point(field_unsafe_arena_release:User.email)
  GOOGLE_DCHECK(GetArena() != nullptr);
...
inline void User::unsafe_arena_set_allocated_email(
  ...
  email_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      email, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:User.email)
}
...
inline void User::set_phone(std::string&& value) {
  ...
  phone_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:User.phone)
}
inline void User::set_phone(const char* value) {
  ...
  phone_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:User.phone)
}
inline void User::set_phone(const char* value,
    size_t size) {
  ...
  phone_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:User.phone)
}
...
inline std::string* User::unsafe_arena_release_phone() {
  // @@protoc_insertion_point(field_unsafe_arena_release:User.phone)
  GOOGLE_DCHECK(GetArena() != nullptr);
...
inline void User::unsafe_arena_set_allocated_phone(
  ...
  phone_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      phone, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:User.phone)
}
