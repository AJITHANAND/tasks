...
static ::_pb::Metadata file_level_metadata_test_5f1_2eproto[1];
static constexpr const ::_pb::EnumDescriptor**
    file_level_enum_descriptors_test_5f1_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor**
    file_level_service_descriptors_test_5f1_2eproto = nullptr;
const ::uint32_t TableStruct_test_5f1_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    ...
    PROTOBUF_FIELD_OFFSET(::USER::User, _impl_.passwd_),
    PROTOBUF_FIELD_OFFSET(::USER::User, _impl_.phone_),
    0,
    1,
    2,
    3,
...
const char descriptor_table_protodef_test_5f1_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    "\n\014test_1.proto\022\004USER\"\240\001\n\004User\022\021\n\004name\030\001 "
    "\001(\tH\000\210\001\001\022\024\n\007address\030\002 \001(\tH\001\210\001\001\022\022\n\005email\030"
    "\003 \001(\tH\002\210\001\001\022\023\n\006passwd\030\004 \001(\tH\003\210\001\001\022\022\n\005phone"
    "\030\005 \001(\003H\004\210\001\001B\007\n\005_nameB\n\n\010_addressB\010\n\006_ema"
    "ilB\t\n\007_passwdB\010\n\006_phoneb\006proto3"
};
static ::absl::once_flag descriptor_table_test_5f1_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_test_5f1_2eproto = {
    false,
    false,
    191,
    descriptor_table_protodef_test_5f1_2eproto,
    "test_1.proto",
    &descriptor_table_test_5f1_2eproto_once,
    nullptr,
    0,
    1,
    schemas,
    file_default_instances,
    TableStruct_test_5f1_2eproto::offsets,
    file_level_metadata_test_5f1_2eproto,
    file_level_enum_descriptors_test_5f1_2eproto,
    file_level_service_descriptors_test_5f1_2eproto,
};
...
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_test_5f1_2eproto_getter() {
  return &descriptor_table_test_5f1_2eproto;
}
// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2
static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_test_5f1_2eproto(&descriptor_table_test_5f1_2eproto);
namespace USER {
// ===================================================================
...
User::User(
  ...
  _impl_.phone_ = from._impl_.phone_;
...
const ::_pbi::TcParseTable<3, 5, 0, 40, 2> User::_table_ = {
  {
    ...
    {::_pbi::TcParser::FastUS1,
     {18, 1, 0, PROTOBUF_FIELD_OFFSET(User, _impl_.address_)}},
    // optional string email = 3;
    {::_pbi::TcParser::FastUS1,
     {26, 2, 0, PROTOBUF_FIELD_OFFSET(User, _impl_.email_)}},
    // optional string passwd = 4;
    {::_pbi::TcParser::FastUS1,
     {34, 3, 0, PROTOBUF_FIELD_OFFSET(User, _impl_.passwd_)}},
    // optional int64 phone = 5;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint64_t, offsetof(User, _impl_.phone_), 4>(),
     {40, 4, 0, PROTOBUF_FIELD_OFFSET(User, _impl_.phone_)}},
    {::_pbi::TcParser::MiniParse, {}},
    {::_pbi::TcParser::MiniParse, {}},
  }}, {{
    65535, 65535
    ...
    // optional string address = 2;
    {PROTOBUF_FIELD_OFFSET(User, _impl_.address_), _Internal::kHasBitsOffset + 1, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // optional string email = 3;
    {PROTOBUF_FIELD_OFFSET(User, _impl_.email_), _Internal::kHasBitsOffset + 2, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // optional string passwd = 4;
    {PROTOBUF_FIELD_OFFSET(User, _impl_.passwd_), _Internal::kHasBitsOffset + 3, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // optional int64 phone = 5;
...
::uint8_t* User::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000002u) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "USER.User.address");
  ...
  if (cached_has_bits & 0x00000008u) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "USER.User.passwd");
  ...
  if (cached_has_bits & 0x00000010u) {
    target = ::google::protobuf::internal::WireFormatLite::
        WriteInt64ToArrayWithField<5>(
            stream, this->_internal_phone(), target);
  }
...
void User::MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg) {
  ...
  if (cached_has_bits & 0x0000001fu) {
    ...
    if (cached_has_bits & 0x00000010u) {
      _this->_impl_.phone_ = from._impl_.phone_;
    }
...
::google::protobuf::Metadata User::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_test_5f1_2eproto_getter, &descriptor_table_test_5f1_2eproto_once,
      file_level_metadata_test_5f1_2eproto[0]);
}
